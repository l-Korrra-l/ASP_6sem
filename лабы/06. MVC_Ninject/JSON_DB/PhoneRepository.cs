...
namespace JSON_DB
{
    public sealed class PhoneRepository : IRepository<Phone>
    {
        ...
        public void SaveModel()
        {
            ...
            File.WriteAllText(@"C:\Users\User\Documents\Study_6sem\ПИС\Labs\Lab6\JSON_DB\PhonesDB.json", json);
        }

        public void LoadModel()
        {
            Phones = JsonSerializer.Deserialize<List<Phone>>(File.ReadAllText(@"C:\Users\User\Documents\Study_6sem\ПИС\Labs\Lab6\JSON_DB\PhonesDB.json"));
        }
